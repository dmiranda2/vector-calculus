...
\markboth{}{} \addcontentsline{toc}{chapter}{Line and Surface Integrals}
\markright{Line and Surface Integrals}
%Begin Section 4.1
...
direction of \textbf{T} (i.e. in the direction of $C$), which is a useful physical interpretation of line integrals.
   %\startexercises
\section*{\psframebox{Homework}}\begin{multicols}{2}\columnseprule 1pt \columnsep 25pt\multicoltolerance=900
\probs{A}
...
\begin{exa}\label{exa:conhelix}
 ...
 \begin{figure}[h]
  \begin{center}
  % \includegraphics{./figs/./figs/fig451}
